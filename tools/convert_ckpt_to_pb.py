...
def _add_output_tensor_nodes(net, preprocess_tensors, output_collection_name='inferece_op'):
    ...
    outputs['pose_output'] = tf.identity(net._predictions['pose_output'], name='pose_output')
    for output_key in outputs.keys():
        tf.add_to_collection(output_collection_name, outputs[output_key])
    return outputs
...
def _export_inference_graph(trained_checkpoint_prefix,
    ...
    frozen_graph_path = os.path.join(output_directory,
                                     'mobilev1_headpose.pb')
    saved_model_path = os.path.join(output_directory, 'saved_model')
    # model_path = os.path.join(output_directory, 'mobilev1_0.75_ssh_iter_400000.ckpt')
...
def export_inference_graph(trained_checkpoint_prefix,
                           output_directory,
                           output_collection_name='mobilev1_headpose',
                           additional_output_tensor_names=None,
                           write_inference_graph=False):
...
if __name__ == '__main__':
    # ckpt_path = '/home/oeasy/PycharmProjects/tf-ssh_modify/output/mobile/wider_face_train/mobile_ssh_iter_400000.ckpt'
    # ckpt_path = '/home/oeasy/PycharmProjects/tf-ssh_modify/output/vgg16/wider_face_train/default/vgg16_ssh_iter_300000.ckpt'
    ckpt_path = '/home/oeasy/PycharmProjects/deep-head-pose-tf/output/mobile/Pose_300W_LP/default_alpha_0.01/mobile_hopenet_epoch_60.ckpt'
    output_dir = '/home/oeasy/PycharmProjects/deep-head-pose-tf/output/mobile/Pose_300W_LP/default_alpha_0.01/pb_ckpt_1.2'
